...
<script>
	...
	import My_header from '../components/children/My_header.vue';
	import Subject from '../components/children/subject.vue';
	import Center from '../components/children/center.vue';
	import Commodity from '../components/children/commodity.vue';
	export default {
		components: {
			My_header,
			Subject,
